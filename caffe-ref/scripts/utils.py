...
def write_conv_weights(net, layer_name, c_file_name, h_file_name):
    ...
    def_filter_h = layer_name.upper() + 'FILTER_HEIGHT'
    def_filter_w = layer_name.upper() + 'FILTER_WIDTH'
    ...
    c_file.write('const float {:s}_weights[{:s}][{:s}*{:s}*{:s}] = {\n'.format(layer_name, def_no_outputs, def_no_inputs, def_filter_h, def_filter_w))
