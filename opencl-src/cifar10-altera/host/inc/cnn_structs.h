...
typedef struct {
	...
	// allocate separate input buffer to support padding. If we don't want to support padding, 
	// then output buffer of previous layer can be used as input buffer for this layer.
