...
int main()
{
	   ...
	   {
	       sprintf(filenameinput, "../conv2/output3d%d.pgm",j);	
	   ...
	   if (!kernel[0] || err != CL_SUCCESS)
	   {
 	   ...
 	   // Create the input and output arrays in device memory for our calculation
       	   d_image  = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR /*| CL_MEM_USE_MSMC_TI*/, mem_size_image*CONV2_NO_OUTPUTS, h_image, &err);
