...
/*
	   ...
	   if (!kernel[3] || err != CL_SUCCESS)
	   {
 	   ...
 	   // Create the input and output arrays in device memory for our calculation
       	   ...
       	   d_output1  = clCreateBuffer(context, CL_MEM_WRITE_ONLY, mem_size_output1, NULL, &err);
       	  ...
       	  /* d_weights2 = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR , mem_size_weights2, h_weights2, &err);
       	   d_output2  = clCreateBuffer(context, CL_MEM_WRITE_ONLY , mem_size_output2, NULL, &err);
